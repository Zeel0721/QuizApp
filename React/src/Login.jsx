...
export default function Login({ setAuthenticate }) {
  ...
  function validateUser(){
    ...
    if(uname === "root" && pwd === "root"){
      openNotification("Success","Login Successfull")
      sessionStorage.setItem('authorised','true')
      setAuthenticate(true)
    }
    else
      openNotification("Error","Wrong Credentials")
  }

  return (
    <div className='login'>
      <Form className='login-from' name="basic" 
        style={{maxWidth: 600}}
        size = 'large'
        initialValues={{
          remember: true,
      ...
      >
        ...
        <Form.Item>
          <Button className='primary-btn' id='login-submit' type="primary" htmlType="submit">
            Login
          </Button>
        </Form.Item>
      </Form>

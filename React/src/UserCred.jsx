  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Input className="login-input" style={inputStyle} id="firstname" />
        </Form.Item>
        <Form.Item
          className="input-field"
          name="lastname"
        ...
        >
          <Input className="login-input" style={inputStyle} id="lastname" />
        </Form.Item>
        <Form.Item
          className="input-field"
          name="email"
        ...
        >
          <Input className="login-input" style={inputStyle} id="email" />
        </Form.Item>
        <Form.Item>
          <Button
